...
name = "cosmology_bridge"

def compile(cfg: Dict[str, Any]) -> Dict[str, Any]:
    # TODO: implement finite projection Π_cosmology_bridge into ΩI + error budget.
    return {"module":"cosmology_bridge","Pi":"TODO","delta":"TODO","notes":"scaffold"}
